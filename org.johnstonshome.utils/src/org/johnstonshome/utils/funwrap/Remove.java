...
/**
 * A wrapper class around the function {@link Functional#remove(Collection, MapFunction)}
 ...
 */
public class Remove<V> implements Operation<Collection<V>, Collection<V>, MapFunction<V, Boolean>> {
	...
	public static <V> CurriedOperation<Collection<V>, Collection<V>, MapFunction<V, Boolean>> 
		...
		return new CurriedOperation<Collection<V>, Collection<V>, MapFunction<V, Boolean>>(new Remove<V>(), function);
	}
