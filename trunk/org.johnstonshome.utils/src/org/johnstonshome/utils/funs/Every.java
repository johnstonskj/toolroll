...
/**
 * A wrapper class around the function {@link Functional#every(Collection, UnaryFunction)}
 ...
 */
public class Every<V> implements BinaryFunction<Boolean, Collection<V>, UnaryPredicate<V>> {
	...
	public static <V> CurriedBinaryFunction<Boolean, Collection<V>, UnaryPredicate<V>>
		...
		return new CurriedBinaryFunction<Boolean, Collection<V>, UnaryPredicate<V>>(new Every<V>(), function);
	}
}
