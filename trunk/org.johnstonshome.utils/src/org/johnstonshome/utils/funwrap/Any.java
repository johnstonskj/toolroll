...
/**
 * A wrapper class around the function {@link Functional#any(Collection, MapFunction)}
 ...
 */
public class Any<V> implements Operation<Boolean, Collection<V>, MapFunction<V, Boolean>> {
	...
	public static <V> CurriedOperation<Boolean, Collection<V>, MapFunction<V, Boolean>>
		...
		return new CurriedOperation<Boolean, Collection<V>, MapFunction<V, Boolean>>(new Any<V>(), function);
	}
}
